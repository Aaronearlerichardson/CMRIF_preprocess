...
ORIG_DATA_DIR="$HOME/ebs/RAW" #input directory, on server: \\132.236.250.219\fMRI\RAW Backups of medata \\132.236.250.219\fMRI\projects\temp$

OUTPUT_DIR="$HOME/ebs" #on server:
